/**
 * Boilerplate text for the Common Paper Mutual Non-Disclosure Agreement,
 * transcribed from ../../../templates/Mutual-NDA.md and
 * ../../../templates/Mutual-NDA-coverpage.md (see /catalog.json).
 *
 * Common Paper Mutual Non-Disclosure Agreement (Version 1.0), free to use
 * and modify under CC BY 4.0: https://creativecommons.org/licenses/by/4.0/
 *
 * `{{Token}}` placeholders stand in for the `coverpage_link` fields the
 * source document resolves against the Cover Page; buildNdaDocument()
 * substitutes them with the values the user entered in the form.
 */

export const MNDA_TITLE = "Mutual Non-Disclosure Agreement";

export const SOURCE_FOOTER =
  "Common Paper Mutual Non-Disclosure Agreement (Version 1.0), free to use under CC BY 4.0 (https://creativecommons.org/licenses/by/4.0/). Generated with the Prelegal Mutual NDA creator.";
...
export const STANDARD_TERMS_INTRO: StandardTermClause = {
